...
| You have | Goes to |
| --- | --- |
| A question, or self-hosting that won't behave | [An issue labelled `question`](https://github.com/aaron-rai/OpenGym/issues) |
| An idea you're not sure about yet | [An issue labelled `idea`](https://github.com/aaron-rai/OpenGym/issues) |
| A reproducible bug | [Issues](https://github.com/aaron-rai/OpenGym/issues) |
| A change you've already built | A pull request |

Questions and ideas are issues too — just labelled, so nobody mistakes a question for agreed-on
work. An answered question is worth more than the same answer in chat: the next person searching
"passkey login fails behind my reverse proxy" finds it.
