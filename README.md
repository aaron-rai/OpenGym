...
<br>
[![Tests](https://img.shields.io/github/actions/workflow/status/aaron-rai/OpenGym/test.yaml?branch=main&style=flat-square)](https://github.com/aaron-rai/OpenGym/actions/workflows/test.yaml)
![Last commit](https://img.shields.io/github/last-commit/aaron-rai/OpenGym?style=flat-square)
[![Stars](https://img.shields.io/github/stars/aaron-rai/OpenGym?style=flat-square)](https://github.com/aaron-rai/OpenGym/stargazers)
[![Issues](https://img.shields.io/github/issues/aaron-rai/OpenGym?style=flat-square)](https://github.com/aaron-rai/OpenGym/issues)
...
### [📦 Source on GitHub](https://github.com/aaron-rai/OpenGym)
...
- 📱 **Standalone Android app** — the whole tracker as a sideloadable APK: no account, no server, data on the phone, native workout reminders, and an in-app update check against your own instance (build your own from source, see [docs/MOBILE.md](docs/MOBILE.md))
...
```bash
git clone https://github.com/aaron-rai/OpenGym
cd OpenGym
cp .env.example .env
...
GHCR? Drop the `pull` step and run `docker compose up -d --build` — you don't need Node or
...
- **Android:** build and sideload your own APK — openGym is deliberately not on the Play Store,
  and this fork doesn't publish prebuilt ones. See **[docs/MOBILE.md](docs/MOBILE.md)**.
...
The plan lives in [ROADMAP.md](ROADMAP.md) and, upstream, on the
[GitLab milestones](https://gitlab.com/DuarteSantos8/opengym/-/milestones): v1.3.5 programmes and
...
mobile (timer in the notification bar, widgets, Withings). This fork tracks that roadmap by pulling
in upstream releases — see [CONTRIBUTING.md](CONTRIBUTING.md) for how this fork's own changes get
made.
...
- **[Issues](https://github.com/aaron-rai/OpenGym/issues)** — bugs, questions, self-hosting
  help and ideas. Label a question `question` and an idea `idea`, so nothing gets mistaken for
  agreed-on work.
...
- **Pull requests** — [open one on GitHub](https://github.com/aaron-rai/OpenGym/pulls); see
...
openGym is free and stays free: AGPL, no subscription, no paid tier.
