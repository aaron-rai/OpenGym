...
- 📱 **Standalone Android app** — the whole tracker as a sideloadable APK: no account, no server, data on the phone, native workout reminders (build your own from source, see [docs/MOBILE.md](docs/MOBILE.md))
...
- [x] Standalone mobile app — Android APK to sideload (build your own, see [docs/MOBILE.md](docs/MOBILE.md)); on iOS as a self-hosted PWA (no store listings planned)
